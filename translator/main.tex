...
\begin{titlepage}
    \centering
    \vspace*{2cm}
    {\Large \textit{ChatGPT, AI Tạo sinh, Mô hình Ngôn ngữ Lớn và Tư vấn Đầu tư}}\\[1cm]
    \vspace{2cm}
    \textbf{Tác giả chính của bài báo:}\\[0.2cm]
    Lei Huang, Fangzhou Lu, Sixuan Li\\[1cm]
    \textbf{Người thực hiện dịch:}\\[0.2cm]
    Nguyễn Vũ Quang Anh\\
    Trịnh Tuấn Ngọc Bảo\\
...
Nghiên cứu này áp dụng phương pháp tiếp cận đa ngôn ngữ và đa nguồn dữ liệu để đánh giá hiệu quả của LLMs trong phân tích tài chính. Sử dụng hai loại dữ liệu văn bản khác nhau bằng các ngôn ngữ khác nhau – các bài báo từ Wall Street Journal ở Hoa Kỳ và các thông báo chính sách từ chính phủ Trung Quốc – nhóm tác giả chỉ ra rằng ChatGPT có thể tạo ra các danh mục đầu tư với hệ số \textbf{alpha ba yếu tố hàng tháng lên tới 3\%}, đặc biệt là khi phản ứng với các tin tức liên quan đến chính sách. 

Kết quả nghiên cứu cũng tiết lộ ba phát hiện quan trọng: (1) Khả năng xử lý ngôn ngữ tự nhiên của LLMs cho phép trích xuất thông tin tài chính tinh vi từ các nguồn phi cấu trúc; (2) Hiệu suất vượt trội thể hiện rõ nhất trong bối cảnh thị trường biến động cao; (3) Mô hình đạt hiệu quả tối ưu khi kết hợp cả phân tích định lượng và định tính. Khi so sánh kết quả này với những phương pháp phân tích văn bản truyền thống dựa trên từ khóa và tần suất xuất hiện, nghiên cứu cho thấy phương pháp truyền thống không tạo ra được các danh mục đầu tư có alpha dương, đồng thời có độ nhạy thấp hơn đối với các yếu tố vĩ mô.

Những phát hiện này không chỉ chứng minh tính khả thi của việc ứng dụng LLMs trong quản lý danh mục đầu tư mà còn mở ra hướng nghiên cứu mới về tích hợp AI trong phân tích tài chính đa chiều. Nghiên cứu gợi ý rằng sự kết hợp giữa LLMs và các mô hình dự báo truyền thống có thể tạo ra hệ thống hỗ trợ quyết định đầu tư tối ưu trong tương lai.
\end{abstract}
